...
| :---: | :--- | :---: | :---: | :---: | :--- |
| **Part I** | **General Awareness** (Defence, Aviation, HAL milestones, Current Affairs) | **20 MCQs** | 12–15 Minutes | **14+ / 20** | Direct recall; mark or skip in <30s each |
| **Part II** | **English & Reasoning** (Verbal, Logical, Series, Direction, Syllogisms) | **40 MCQs** | 30–35 Minutes | **32+ / 40** | High accuracy; fast pattern elimination |
| **Part III** | **Computer Science Discipline** (OS, COA, CN, DBMS, DSA, Digital, TOC, SE) | **100 MCQs** | 90–95 Minutes | **80+ / 100** | Core technical speed & numerical precision |
| **Total** | | **160 MCQs** | **140 Mins (+10m buffer)** | **125+ / 160** | **Rank #1 / Top OBC-NCL Target** |
...
* **Computer Organization & Architecture (COA)**: Cache Memory Mapping (Direct, Fully Associative, Set-Associative), Cache replacement & write policies (Write-through vs Write-back), Instruction Pipelining (Clock cycle time, Speedup, Hazards: RAW, WAR, WAW, Structural, Branch penalty), Instruction formats (Opcode expansion).
* **General Awareness (Aviation & Defence)**: HAL milestones, indigenous platforms (LCA Tejas, Tejas Mk1A, Prachand LCH, LUH, HTT-40, AMCA, IMRH), Indian aerospace history and current defence leadership.
* **Drill Artifact**: [`DRILL-01-OS-COA.md`](DRILL-01-OS-COA.md)
...
* **DBMS**: Relational Algebra (Selection, Projection, Joins), Normalization (1NF, 2NF, 3NF, BCNF lossless & dependency preserving criteria), Transaction Processing & ACID properties, Concurrency Control (2PL, Strict 2PL, Timestamp ordering, Thomas Write Rule), Indexing (B-Trees vs B+ Trees fan-out and height calculations), SQL (HAVING vs WHERE, subqueries, group by, constraints).
* **Data Structures & Algorithms**: Asymptotic Notations & Recurrence Relations (Master Theorem), Arrays, Linked Lists, Stacks & Queues, Binary Trees & BST (traversals, properties), Heaps & Priority Queues, Graph Algorithms (BFS, DFS, Dijkstra, Bellman-Ford, Kruskal, Prim), Sorting algorithms (Time & Space complexity, Stability, Min/Max comparisons).
* **General English**: Sentence correction, Spotting errors, Prepositions, Subject-Verb agreement, Synonyms/Antonyms, Idioms & Phrases.
...
* **Morning**: 160-Question Timed Full Mock Simulation (150 minutes).
* **Afternoon**: Error log analysis and targeted weakness reinforcement.
* **Evening**: Master formula and short definition rapid review. Early sleep by 10:00 PM.
...
3. **Second-Pass Calculation (60 to 130 mins)**: Solve numericals in Paging, Subnetting, Pipelining, Digital Logic, and Quant/Reasoning.
4. **Final Review & Educated Guesses (130 to 150 mins)**: Verify flagged questions, eliminate distractor options, and ensure zero unattempted items.
