...
- **Status**: FAILED CBT. OBC cutoff was 112 marks. Core CS weakness.

### BEL MT -- Bharat Electronics Limited
- **Status**: FAILED CBT. Core CS weakness.

### CBSE Assistant Secretary
- **Status**: FAILED. Could not clear cutoff.

### GATE 2026 CS
- **Status**: Completed (Score: 21) — Not usable for PSU shortlists.

### GATE 2026 DA
- **Status**: Completed (Score: 28) — Not usable for PSU shortlists.
