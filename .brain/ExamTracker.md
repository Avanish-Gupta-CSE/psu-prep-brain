...
| Field | Details |
|-------|---------|
| **Date** | **19 July 2026 (Sunday) — Personal Interview** |
| **Reporting Time** | **09:00 AM** |
| **Venue** | Software Technology Parks of India, Plate-B, 1st Floor, Office Block-1, East Kidwai Nagar, New Delhi-110023 |
| **Status** | **🔥 SHORTLISTED FOR INTERVIEW! (CBT Score: 96/150)** |
| **Vacancies** | **1 vacancy (OBC-NCL)** — Competing against 9 other shortlisted candidates. |
| **Scale / Level** | **Level-10 (Rs. 56100-177500)** — Gazetted-equivalent central government post. |
| **Priority** | **CRITICAL (Primary Dream Target)** |

### 3. Balmer Lawrie -- Executive Trainee (IT)
| Field | Details |
|-------|---------|
| **Date** | **15 July 2026 (Wednesday) — CBT Exam** |
| **Status** | **ADMIT CARD RECEIVED** |
| **Vacancies** | 6 vacancies (UR: 2, OBC-NCL: 2, SC: 1, EWS: 1) |
| **Pattern** | 100 MCQs in 90 minutes. **1/4th Negative Marking!**<br>• Section 1 (40 Marks): General Engineering (Generic common subjects for all streams).<br>• Section 2 (60 Marks): Aptitude (Logical Reasoning, DI, Quant, and English). |
| **Priority** | **HIGH (Practice/Backup under zero pressure)** |

### 4. Coal India Limited (CIL) -- Management Trainee (Systems)
| Field | Details |
|-------|---------|
...
- **Status**: **CBT COMPLETED (11 July 2026)**. Exam went very well. Awaiting result/interview updates.
...
### GATE 2026 CS / DA
- **Status**: Completed (Score: 21 / 28) — Closed.
